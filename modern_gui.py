...
def start_gui():
    ...
    start_button_arp = ttk.Button(root, text='start').grid(row=3, column=2, padx=5, pady=5)
    stop_button_arp = ttk.Button(root, text="stop").grid(row=3, column=3, padx=5, pady=5)

    dns_spoofing_label = Label(root, text="DNS spoofing").grid(row=4, column=0)
    spacing_label.grid(row=4, column=1)
    start_button_arp = ttk.Button(root, text='start').grid(row=4, column=2, padx=5, pady=5)
    stop_button_arp = ttk.Button(root, text="stop").grid(row=4, column=3, padx=5, pady=5)

    http_server_label = Label(root, text="HTTP server").grid(row=5, column=0)
    spacing_label.grid(row=5, column=1)
    start_button_arp = ttk.Button(root, text='start').grid(row=5, column=2, padx=5, pady=5)
    stop_button_arp = ttk.Button(root, text="stop").grid(row=5, column=3, padx=5, pady=5)

    proxy_server_label = Label(root, text="Proxy server").grid(row=6, column=0)
    spacing_label.grid(row=6, column=1)
    start_button_arp = ttk.Button(root, text='start').grid(row=6, column=2, padx=5, pady=5)
    stop_button_arp = ttk.Button(root, text="stop").grid(row=6, column=3, padx=5, pady=5)
